...
shephards_pie = Recipe.create(author: eva.email, name: "Shephard's Pie", photo_url: "http://images.media-allrecipes.com/userphotos/250x250/980198.jpg", servings: 6, total_cost: 15, difficulty: "easy", directions: "	1. Preheat the oven to 400 degrees. Grease a casserole dish and set aside.
...
egg_muffin = Recipe.create(author: norbsie.email, name: "Bacon & Veggie Egg Muffins", photo_url: "https://farm8.staticflickr.com/7346/16593215412_81d3eecf0d_c.jpg", servings: 16, total_cost: 20, difficulty: "easy", directions: "	1. Grease a muffin tin and preheat oven to 375 F.
	2. Cook bacon fully.
...
chickpea = Recipe.create(author: norbsie.email, name: "Curried Cauliflower Chickpea Wraps", photo_url: "http://themuffinmyth.com/wp-content/uploads/2015/03/curried_cauliflower_wraps_3.jpg", servings: 6, total_cost: 30, difficulty: "hard", directions: "	1. Start with breaking down the cauliflower into large chunks.
